...
#### 3. How does having ever served on active duty in the United States Armed Forces relate to the number of days a person’s mental health has not been good over the 30 days pre-interview?
...
#### 4. How does having ever served on active duty in the United States Armed Forces relate to the average sleep hours a person gets in a 24-hour period?

**Background:** There is evidence about the prevalence of sleep disorders (most commonly chronic insomnia and nightmares) in those who suffer from PTSD (Gehrman, 2015). We want to test out this existing relationship by establishing a correlation between veterans that have been diagnosed with a depressive disorder at least once in their lifetime and the number of sleep hours that they get in a 24-hour basis.
...
To explore this question we should divide people into two groups: those who have ever been told to have a depressive disorder and those who have not. After that is done, we should evaluate the sleep time distribution of each of the groups. To further understand the difference (if there is any) between the sleep time of those who have ever been diagnosed and those who not, we superimpose both frequency distribution histograms.
