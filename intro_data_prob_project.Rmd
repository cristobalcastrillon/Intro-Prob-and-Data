...
a. How does the number of days that a person’s mental health has not been good over the 30 days pre-interview relates to whether he or she have ever been told to have a depressive disorder and to whether he or she have served on active duty in the United States Armed Forces?
...
#### Superimposed Density plot - SLEPTIM1 and MENTHLTH
```{r}
plot(density(sleptim1_vs_menthlth$sleptim1), ylim = c(0, 2.7))
